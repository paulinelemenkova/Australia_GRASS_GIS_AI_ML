...
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B1.TIF output=L_2015_01 extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B2.TIF output=L_2015_02 extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B3.TIF output=L_2015_03 extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B4.TIF output=L_2015_04 extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B5.TIF output=L_2015_05 extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B6.TIF output=L_2015_06 extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Melbourne/LC08_L2SP_093086_20150329_20200909_02_T1_SR_B7.TIF output=L_2015_07 extent=region resolution=region --overwrite
#
g.list rast
...
d.out.file output=Melbourne_2015 format=jpg --overwrite
#
...
d.grid -g size=00:30:00 color=grey width=0.1 fontsize=16 text_color=grey
d.legend raster=L_2015_cluster_reject title="2015" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.out.file output=Melbourne_2015_reject format=jpg --overwrite
#
# --------------------- MACHINE LEARNING ------------------------>
...
d.grid -g size=00:30:00 color=grey width=0.1 fontsize=16 text_color=grey
d.legend raster=rf_classification title="RF 2015" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.out.file output=RF_2015 format=jpg --overwrite
# ------------------------<
...
# perform prediction using r.learn.predict
r.learn.predict group=L_2015 load_model=dtc_model.gz output=dtc_classification --overwrite
# display
r.colors dtc_classification color=bgyr -e
d.mon wx0
d.rast dtc_classification
d.grid -g size=00:30:00 color=grey width=0.1 fontsize=16 text_color=grey
d.legend raster=dtc_classification title="DTC 2015" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.out.file output=DTC_2015 format=jpg --overwrite
...
# display
r.colors mlpc_classification color=bgyr -e
d.mon wx0
d.rast mlpc_classification
d.grid -g size=00:30:00 color=grey width=0.1 fontsize=16 text_color=grey
d.legend raster=mlpc_classification title="ANN 2015" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.out.file output=MLPC_2015 format=jpg --overwrite
